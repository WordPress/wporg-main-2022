...
<h1 class="wp-block-heading has-heading-2-font-size" style="margin-bottom:var(--wp--preset--spacing--30)"><?php _e( 'Swag', 'wporg' ); ?></h1>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><?php _e( 'The swag store also rotates other products through the lineup on a regular basis.', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"20%"} -->
<div class="wp-block-column" style="flex-basis:20%"><!-- wp:image {"id":17146,"sizeSlug":"medium","linkDestination":"custom"} -->
<figure class="wp-block-image size-medium"><a href="https://mercantile.wordpress.org/"><img src="https://wordpress.org/files/2023/02/swag_col-1-224x300.jpg" alt="" class="wp-image-17146" /></a></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->

<!-- wp:paragraph -->
<p><?php _e( 'The proceeds from these sales help offset the cost of providing free swag (buttons, stickers, etc.) to WordCamps and WordPress meetups around the world.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'So show the love and spread the word — get your&nbsp;<a href="https://mercantile.wordpress.org/">WordPress swag</a>&nbsp;today.', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
