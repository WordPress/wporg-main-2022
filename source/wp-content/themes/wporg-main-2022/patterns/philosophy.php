...
/**
 * Title: Philosophy 2
 * Slug: wporg-main-2022/philosophy-2
 * Inserter: no
 */
...
<h1 class="wp-block-heading has-heading-2-font-size" style="margin-bottom:var(--wp--preset--spacing--30)"><?php _e( 'Philosophy', 'wporg' ); ?></h1>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><?php _e( 'Great software should work with little configuration and setup. WordPress is designed to get you up and running and fully functional in no longer than five minutes. You shouldn’t have to battle to use the standard functionality of WordPress.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php _e( 'Deadlines are not arbitrary, they’re a promise we make to ourselves and our users that helps us rein in the endless possibilities of things that could be a part of every release. We aspire to release three major versions a year because through trial and error we’ve found that to be a good balance between getting cool stuff in each release and not so much that we end up breaking more than we add.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'Good deadlines almost always make you trim something from a release. This is not a bad thing, it’s what they’re supposed to do.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'The route of delaying a release for that one-more-feature is a rabbit hole. We did that for over a year once, and it wasn’t pleasant for anybody.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php _e( 'There’s a good rule of thumb within internet culture called the 1% rule. It states that “the number of people who create content on the internet represents approximately 1% (or less) of the people actually viewing that content”.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php _e( 'WordPress is licensed under the General Public License (GPLv2 or later) which provides four core freedoms, consider this as the WordPress “bill of rights”:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php _e( 'Part of those licensing requirements include licensing derivative works or things that link core WordPress functions (like themes, plugins, etc.) under the GPL as well, thereby passing on the freedom of use for these works as well.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'Obviously there are those who will try to get around these ideals and restrict the freedom of their users by trying to find loopholes or somehow circumvent the intention of the WordPress licensing, which is to ensure freedom of use. We believe that the community as a whole will reward those who focus on supporting these licensing freedoms instead of trying to avoid them.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'The WordPress community should emphasize that the freedoms in the GPL help provide high quality software.', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
