...
<!-- /wp:heading --></div>
 ...
 <!-- wp:paragraph -->
 <p><?php _e( 'The hosts listed here are a great starting point for any type of site you want to build. If you do decide to choose one of them (using the links below), some will donate a portion of your fee right back to the WordPress project—so you can have a great host and support the future of WordPress. If you’d like to try WordPress for free, you can get started with a free website or blog at', 'wporg' ); ?> <a href="https://www.WordPress.com"><?php _e( 'WordPress.com', 'wporg' ); ?></a>.</p>
 <!-- /wp:paragraph -->
 ...
 <figure class="wp-block-image size-full is-resized"><img src="https://wordpress.org/files/2023/02/logo-bluehost.png" alt="Bluehost logo" class="wp-image-17181" width="230"/></figure>
 <!-- /wp:image -->
 
 <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|10","right":"0","bottom":"0","left":"0"}}}} -->
 <p style="padding-top:var(--wp--preset--spacing--10);padding-right:0;padding-bottom:0;padding-left:0"><?php _e( 'Powering over 2 million websites,', 'wporg' ); ?> <a href="https://www.bluehost.com/wordpress-hosting"><?php _e( 'Bluehost', 'wporg' ); ?></a> <?php _e( 'offers the ultimate WordPress platform. Tuned for WordPress, we offer WordPress-centric dashboards and tools along with 1-click installation, a FREE domain name, email, FTP, and more. Easily scalable and backed by legendary 24/7 support by in-house WordPress experts.', 'wporg' ); ?></p>
 <!-- /wp:paragraph -->
 
 <!-- wp:paragraph -->
 <p><a class="external-link" href="https://www.bluehost.com/wordpress-hosting"><?php _e( 'Go to host website', 'wporg' ); ?></a> · <a href="https://wordpress.org/search/Bluehost/?in=support_forums"><?php _e( 'Read forum threads', 'wporg' ); ?></a></p>
 <!-- /wp:paragraph --></div>
 <!-- /wp:group --></div>
 <!-- /wp:group -->
 ...
 <figure class="wp-block-image size-full is-resized"><img src="https://wordpress.org/files/2023/02/logo-siteground.png" alt="Siteground" class="wp-image-17183" width="230"/></figure>
 <!-- /wp:image -->
 
 <!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|10"}}}} -->
 <p style="padding-top:var(--wp--preset--spacing--10)"><a href="https://www.siteground.com/wordpress-hosting.htm"><?php _e( 'SiteGround', 'wporg' ); ?></a> <?php _e( 'has tools that make managing WordPress sites easy: one-click install, managed updates, WP-Cli, WordPress staging and git integration. We have a very fast support team with advanced WordPress expertise available 24/7. We provide latest speed technologies that make WordPress load faster: NGINX-based caching, SSD-drives, PHP 7, CDN, HTTP/2. We proactively protect the WordPress sites from hacks.', 'wporg' ); ?></p>
 <!-- /wp:paragraph -->
 
 <!-- wp:paragraph -->
 <p><a class="external-link" href="https://www.siteground.com/wordpress-hosting.htm"><?php _e( 'Go to host website', 'wporg' ); ?></a> · <a href="https://wordpress.org/search/SiteGround/?in=support_forums"><?php _e( 'Read forum threads', 'wporg' ); ?></a></p>
 <!-- /wp:paragraph --></div>
 <!-- /wp:group --></div>
 <!-- /wp:group -->
