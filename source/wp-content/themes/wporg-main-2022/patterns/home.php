...
<li><a href="https://learn.wordpress.org/">Learn with WordPress ↗</a></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://wordpress.org/support/">Find support ↗</a></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://developer.wordpress.org/">Dig into the code ↗</a></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><a href="https://www.meetup.com/pro/wordpress/">Meet local WordPress users ↗</a></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
