...
<h1 class="wp-block-heading has-heading-2-font-size" style="margin-bottom:var(--wp--preset--spacing--30)"><?php _e( 'Etiquette', 'wporg' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php _e( 'In the WordPress open source project, we realize that our biggest asset is the community that we foster. The project, as a whole, follows these basic philosophical principles from&nbsp;<a href="http://www.catb.org/esr/writings/cathedral-bazaar/cathedral-bazaar/index.html">The Cathedral and The Bazaar</a>.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><?php _e( 'Any member of the community can donate their time and contribute to the project in any form including design, code, documentation, community building, etc. For more information, go to&nbsp;<a href="https://make.wordpress.org/">make.wordpress.org</a>.', 'wporg' ); ?></li>
<!-- /wp:list-item -->
