...
<!-- wp:navigation {"ref":11576,"textColor":"blueberry-2","overlayMenu":"never"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h1 class="has-heading-3-font-size" style="font-style:italic"><?php _e( 'Number of WordPress [latest_branch] downloads', 'wporg' ); ?></h1>
<!-- /wp:heading -->
