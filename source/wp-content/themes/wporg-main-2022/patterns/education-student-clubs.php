...
<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|charcoal-3"}}},"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|50","left":"var:preset|spacing|edge-space","right":"var:preset|spacing|edge-space"}}},"backgroundColor":"white","textColor":"charcoal-3","layout":{"type":"constrained"}} -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":48874,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="https://wordpress.org/files/2025/12/education-student-club-mast.png" alt="" class="wp-image-48874" /></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<p class="has-heading-6-font-size"><?php _e( '<strong>Learn and Grow</strong>', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-heading-6-font-size"><?php _e( '<strong>Lead and Organize</strong>', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30)"><!-- wp:paragraph {"fontSize":"heading-6"} -->
<p class="has-heading-6-font-size"><?php _e( '<strong>Engage and Connect</strong>', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|edge-space","right":"var:preset|spacing|edge-space"}}},"layout":{"type":"constrained"}} -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|charcoal-2"}}}},"textColor":"charcoal-2","fontSize":"extra-large"} -->
<p class="has-charcoal-2-color has-text-color has-link-color has-extra-large-font-size"><?php _e( '<strong>Request Student Club Creation</strong>', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
