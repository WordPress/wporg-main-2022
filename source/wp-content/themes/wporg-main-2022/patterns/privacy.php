...
<!-- wp:paragraph -->
<p><?php _e( 'We will not use the information you provide when you register for an account, attend our events, receive newsletters, use certain other services, or participate in the WordPress open source project in any other way.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'We will not sell or lease your personal information to third parties unless we have your permission or are required by law to do so.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'We would like to send you email marketing communication which may be of interest to you from time to time. If you have consented to marketing, you may opt out later.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php _e( 'We rely on one or more of the following processing conditions:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><?php _e( 'explicit consent that you have given;', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'legal obligations.', 'wporg' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
...
<!-- wp:paragraph -->
<p><?php _e( 'You have the right to request a copy of the information we hold about you. If you would like a copy of some or all your personal information, please follow the instructions at the end of this section.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'All WordCamp attendee-provided data can be viewed and changed by the attendee via the Access Token URL that is emailed to confirm a successful ticket purchase.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php _e( 'WordPress.org user accounts can be edited by following these steps:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><?php _e( 'You will be redirected to https://profiles.wordpress.org/your_username.', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'Click the “Edit” link next to your username.', 'wporg' ); ?></li>
<!-- /wp:list-item --></ol>
<!-- /wp:list -->

<!-- wp:paragraph -->
<p><?php _e( 'If you would like to request access to your account data, please follow these steps:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><?php _e( 'Enter your email address.', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'Click “Accept Declaration and Request Export”.', 'wporg' ); ?></li>
<!-- /wp:list-item --></ol>
<!-- /wp:list -->
...
<!-- wp:list-item -->
<li><?php _e( 'Click “Accept Declaration and Request Permanent Account Deletion”.', 'wporg' ); ?></li>
<!-- /wp:list-item --></ol>
<!-- /wp:list -->
...
<!-- wp:paragraph -->
<p><?php _e( 'You may have certain rights under data protection law in relation to the personal information we hold about you. In particular, you may have a right to:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:list-item -->
<li><?php _e( 'ask that we update the personal information we hold about you, or independently correct such personal information that you think is incorrect or incomplete;', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'ask that we delete personal information that we hold about you from live systems, or restrict the way in which we use such personal information (for information on deletion from archives, see the “Retention of personal information” section);', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'object to our processing of your personal information; and/or', 'wporg' ); ?></li>
<!-- /wp:list-item -->

<!-- wp:list-item -->
<li><?php _e( 'withdraw your consent to our processing of your personal information (to the extent such processing is based on consent and consent is the only permissible basis for processing).', 'wporg' ); ?></li>
<!-- /wp:list-item --></ul>
<!-- /wp:list -->
