 ...
 * Slug: wporg-main-2022/testimonials-2
 * Inserter: no
 */
...
<!-- wp:navigation {"ref":16920,"textColor":"blueberry-1","backgroundColor":"white","align":"wide","className":"is-style-dropdown-on-mobile","layout":{"type":"flex","justifyContent":"left"},"style":{"spacing":{"blockGap":"24px"}},"fontSize":"small"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h1 class="wp-block-heading has-heading-2-font-size" style="margin-bottom:var(--wp--preset--spacing--30)"><?php _e( 'Testimonials', 'wporg' ); ?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->
