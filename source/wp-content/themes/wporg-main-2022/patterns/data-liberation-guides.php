...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30)"><?php _e( 'Guides', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-width is-style-outline-on-dark"><a class="wp-block-button__link wp-element-button" href="https://github.com/WordPress/move-to-wp/tree/trunk#how-to-contribute"><?php _e( 'Get Started', 'wporg' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->