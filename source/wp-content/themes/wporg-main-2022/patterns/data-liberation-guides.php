...
<div class="wp-block-group alignfull" id="migration-guides" style="padding-right:var(--wp--preset--spacing--edge-space);padding-left:var(--wp--preset--spacing--edge-space)"><!-- wp:spacer {"height":"var:preset|spacing|40"} -->
<div style="height:var(--wp--preset--spacing--40)" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"heading-3","fontFamily":"ibm-plex-sans"} -->
<h1 class="wp-block-heading has-ibm-plex-sans-font-family has-heading-3-font-size" style="font-style:normal;font-weight:400"><?php _e( 'Data Liberation', 'wporg' ); ?></h1>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-ibm-plex-sans-font-family has-extra-large-font-size" style="margin-bottom:var(--wp--preset--spacing--10);font-style:normal;font-weight:600;line-height:1.7"><?php _e( 'Guides', 'wporg' ); ?></h2>
<!-- /wp:heading -->
