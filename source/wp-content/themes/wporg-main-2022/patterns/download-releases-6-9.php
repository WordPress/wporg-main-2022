...
<div class="wp-block-group has-background" style="border-radius:16px;background-color:#9ea5ab"><!-- wp:video {"id":49007,"muted":true,"poster":"https://wordpress.org/files/2025/11/6-9-fit-text.png","className":"has-1-1-aspect-ratio has-16px-radius has-custom-controls"} -->
<figure class="wp-block-video has-1-1-aspect-ratio has-16px-radius has-custom-controls"><video controls muted poster="https://wordpress.org/files/2025/11/6-9-fit-text.png" src="https://wordpress.org/files/2025/12/6-9-fit-text.mp4"></video></figure>
<!-- /wp:video --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
