...
<h3 class="wp-block-heading has-ibm-plex-sans-font-family has-large-font-size" style="font-style:normal;font-weight:600;line-height:1.7"><?php _e( '<strong>Phase 1: Migration Guides</strong>', 'wporg' ); ?></h3>
<!-- /wp:heading -->
...
<p class="has-white-color has-charcoal-0-background-color has-text-color has-background has-link-color has-small-font-size" style="border-radius:2px;padding-top:0;padding-right:6px;padding-bottom:0;padding-left:6px;font-style:normal;font-weight:500;text-transform:uppercase"><?php _e( 'Ongoing', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.7","fontStyle":"normal","fontWeight":"600"},"layout":{"selfStretch":"fill","flexSize":null}},"fontSize":"large","fontFamily":"ibm-plex-sans"} -->
<h3 class="wp-block-heading has-ibm-plex-sans-font-family has-large-font-size" style="font-style:normal;font-weight:600;line-height:1.7"><?php _e( '<strong>Phase 2: Importing and Exporting Structured Data</strong>', 'wporg' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.7","fontStyle":"normal","fontWeight":"600"},"layout":{"selfStretch":"fill","flexSize":null}},"fontSize":"large","fontFamily":"ibm-plex-sans"} -->
<h3 class="wp-block-heading has-ibm-plex-sans-font-family has-large-font-size" style="font-style:normal;font-weight:600;line-height:1.7"><?php _e( '<strong>Phase 3: Liberating Data From Closed Platforms</strong>', 'wporg' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:group {"metadata":{"name":"Status Chip"},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"textTransform":"uppercase","fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|white"}}},"spacing":{"padding":{"top":"0","bottom":"0","left":"6px","right":"6px"}},"border":{"radius":"2px"}},"backgroundColor":"charcoal-0","textColor":"white","fontSize":"small"} -->
<p class="has-white-color has-charcoal-0-background-color has-text-color has-background has-link-color has-small-font-size" style="border-radius:2px;padding-top:0;padding-right:6px;padding-bottom:0;padding-left:6px;font-style:normal;font-weight:500;text-transform:uppercase"><?php _e( 'Started', 'wporg' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":3,"style":{"typography":{"lineHeight":"1.7","fontStyle":"normal","fontWeight":"600"},"layout":{"selfStretch":"fill","flexSize":null}},"fontSize":"large","fontFamily":"ibm-plex-sans"} -->
<h3 class="wp-block-heading has-ibm-plex-sans-font-family has-large-font-size" style="font-style:normal;font-weight:600;line-height:1.7"><?php _e( '<strong>Phase 4: Direct WordPress-to-WordPress Synchronization</strong>', 'wporg' ); ?></h3>
<!-- /wp:heading -->
