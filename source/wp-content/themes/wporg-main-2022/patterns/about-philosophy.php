...
<h1 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Philosophy', 'wporg' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Out of the box', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Design for the majority', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Decisions, not options', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Clean, lean, and mean', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Striving for simplicity', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Deadlines are not arbitrary', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'The vocal minority', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Our bill of rights', 'wporg' ); ?></h2>
<!-- /wp:heading -->
