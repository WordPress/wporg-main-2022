...
<h1 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Privacy policy', 'wporg' ); ?></h1>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Website visitors', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Gathering of personally-identifying information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Protection of certain personally-identifying information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Use of personal information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Legal grounds for processing personal information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Access to data', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Retention of personal information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Rights in relation to your information', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Aggregated statistics', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Privacy policy changes', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading"><?php esc_html_e( 'Contact', 'wporg' ); ?></h2>
<!-- /wp:heading -->
...
<p><?php esc_html_e( 'Please note we cannot provide help or information about other websites, including those which may run on WordPress open source software but are hosted by third parties.', 'wporg' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'We suggest contacting the site owner or author directly. To find more information about the site’s host or domain&nbsp;registrar, you can use these tools:', 'wporg' ); ?></p>
<!-- /wp:paragraph -->
